...
exports.getProductsListName = async (req, res, next) => {
  try {
      ...
      pipeline.push({
        $match: {
          'child_category.category_name': {
            $regex: new RegExp(child_category, 'i')
          }
        }
      });
    }
      ...
      pipeline.push({
        $match: {
          'sub_category.category_name': {
            $regex: new RegExp(sub_category, 'i')
          }
        }
      });
    }
      ...
      pipeline.push({
        $match: {
          'parent_category.category_name': {
            $regex: new RegExp(parent_category, 'i')
          }
        }
      });
    }
